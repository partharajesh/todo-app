...
export function Dashboard() {
  ...
  const { tasks, loading, createTask, updateTask, deleteTask, toggleComplete } = useTasks(user?.id);
          ...
          {showNewList ? (
            <div className="px-2 py-2 bg-gray-50 rounded-lg space-y-2">
              ...
              <div className="flex gap-2">
                ...
                <button onClick={() => setShowNewList(false)} className="text-xs text-gray-500 hover:text-gray-700 px-2 py-1">
                  Cancel
                </button>
              </div>
            </div>
